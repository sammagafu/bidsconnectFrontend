...
export const companiesService = {
  ...
  updateDocument(companyPk, documentId, formData) {
    return api
      .patch(`accounts/companies/${companyPk}/documents/${documentId}/`, formData)
      .then((r) => r.data);
  },
  ...
  deleteDocument(companyPk, documentId) {
    return api
      .delete(`accounts/companies/${companyPk}/documents/${documentId}/`)
      .then((r) => r.data);
  },
  ...
  deleteInvitation(companyPk, invitationId) {
    return api
      .delete(`accounts/companies/${companyPk}/invitations/${invitationId}/`)
      .then((r) => r.data);
  },
  ...
  exportDocuments(companyPk) {
    return api
      .get(`accounts/companies/${companyPk}/documents/export/`, { responseType: 'blob' })
      .then((r) => r.data);
  },
};
