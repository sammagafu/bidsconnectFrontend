<template>
  <VerticalLayout>
    <b-row class="g-1">
      <b-col xxl="3">
        ...
        <div class="d-block d-xl-none">
          <b-offcanvas
            v-model="contactOffcanvas"
            class="offcanvas-xxl h-100"
            placement="start"
      ...
      <b-col xxl="9">
        <b-card no-body class="position-relative overflow-hidden">
          <b-card-header class="d-flex align-items-center mh-100">
            <b-button
              variant="light"
              class="d-xxl-none d-flex align-items-center px-2 me-2"
              type="button"
            ...
            <div class="flex-grow-1">
              <ul class="list-inline float-end d-flex gap-3 mb-0">
                ...
                <li class="list-inline-item fs-20 d-none d-md-flex">
                  <b-dropdown
                    :variant="null"
                    toggle-class="arrow-none text-dark p-0 m-0"
                  ...
                  >
                    ...
                    <b-dropdown-item
                      ><i class="bx bx-user-circle me-2"></i>View Profile</b-dropdown-item
                    >
                    <b-dropdown-item
                      ><i class="bx bx-music me-2"></i>Media, Links and Docs</b-dropdown-item
                    >
                    ...
                    <b-dropdown-item
                      ><i class="bx bx-right-arrow-circle me-2"></i>More</b-dropdown-item
                    >
                  </b-dropdown>
                </li>
              </ul>
          ...
          <div class="chat-box">
            <simplebar class="chat-conversation-list p-3 chatbox-height">
              <template v-for="(content, idx) in chatMessages" :key="idx">
                <li class="clearfix" :class="content.isSender && 'odd'">
                  <div
                    class="chat-conversation-text ms-0"
                    v-for="(msg, idx) in content.msg"
                    :key="idx"
                  >
                    <template v-if="content.isSender">
                      <div class="d-flex justify-content-end">
                        <DropDown customClass="chat-conversation-actions dropstart">
                          ...
                          <div class="dropdown-menu">
                            <a
                              class="dropdown-item"
                              href="javascript: void(0);"
                              v-for="(item, idx) in dropdownItem"
                              :key="idx"
                            >
                        ...
                        <div
                          class="chat-ctext-wrap text-start"
                          v-if="msg.isMedia && msg.mediaContend"
                        >
                    ...
                    <p
                      class="text-muted fs-12 mb-0 mt-1"
                      :class="!content.isSender && 'ms-2'"
                      v-if="content.timeStamp && content.msg.length - 1 === idx"
                    >
                      {{ content.timeStamp
                      }}<i class="bx bx-check-double ms-1 text-primary" v-if="content.isRead"></i>
                    </p>
                  </div>
                </li>
              </template>
            ...
            <div class="bg-body-tertiary p-2">
              <form
                ...
                name="chat-form"
                id="chat-form"
                @submit.prevent="handleYupSubmit"
              >
    ...
    <b-modal
      v-model="voiceModal"
      size="sm"
      content-class="voice-call"
      body-class="pt-0 text-center"
      header-class="border-0 mt-5 justify-content-center"
      hide-footer
      centered
    >
      <template #header>
    ...
    <b-modal
      v-model="videoModal"
      size="sm"
      content-class="video-call"
      header-class="border-0 mb-5 justify-content-end"
      hide-footer
      centered
    >
      <template #header>
