    ...
    <b-row class="g-1 mb-3">
      ...
      <b-col xxl="10">
        <b-card no-body class="position-relative overflow-hidden h-100">
              ...
              <div>
                <ul class="nav nav-tabs nav-justified">
                  ...
                  <li class="nav-item">
                    <a
                      href="#"
                      class="nav-link d-flex align-items-center"
                      :class="showTab === 'updatesMail' && 'active'"
                      @click="filterMails('updates', 'updatesMail')"
                    >
                ...
                <div class="tab-content text-muted pt-0">
                  ...
                  <div
                    class="tab-pane"
                    id="socialMail"
                    :class="showTab === 'socialMail' && 'show active'"
                  >
                    <ul class="message-list mb-0">
                      <template v-for="(mail, idx) in filteredMails" :key="idx">
                        <MailCard :mail="mail" :toggleReadOffcanvas="toggleReadOffcanvas" />
                  ...
                  <div
                    class="tab-pane"
                    id="PromotionsMail"
                    :class="showTab === 'PromotionsMail' && 'show active'"
                  >
                    <ul class="message-list mb-0">
                      <template v-for="(mail, idx) in filteredMails" :key="idx">
                        <MailCard :mail="mail" :toggleReadOffcanvas="toggleReadOffcanvas" />
                  ...
                  <div
                    class="tab-pane"
                    id="updatesMail"
                    :class="showTab === 'updatesMail' && 'show active'"
                  >
                    <ul class="message-list mb-0">
                      <template v-for="(mail, idx) in filteredMails" :key="idx">
                        <MailCard :mail="mail" :toggleReadOffcanvas="toggleReadOffcanvas" />
                  ...
                  <div
                    class="tab-pane"
                    id="forumsMail"
                    :class="showTab === 'forumsMail' && 'show active'"
                  >
                    <ul class="message-list mb-0">
                      <template v-for="(mail, idx) in filteredMails" :key="idx">
                        <MailCard :mail="mail" :toggleReadOffcanvas="toggleReadOffcanvas" />
          ...
          <b-offcanvas
            v-model="showEmail"
            class="email-offcanvas position-absolute shadow"
            placement="end"
