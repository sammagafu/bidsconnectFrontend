    ...
    <b-row>
      <b-col xl="9">
        ...
        <UIComponentCard title="Disabled Checkbox" id="disabled-checkbox">
          <b-form-group class="mt-3">
            <b-form-checkbox v-model="checked" inline disabled
        ...
        <UIComponentCard title="Colors Checkbox" id="colors-checkbox">
          <div class="mt-3">
            <b-form-checkbox id="customCheckcolor1" class="mb-2" checked>
              Default Checkbox
            </b-form-checkbox>
            <b-form-checkbox id="customCheckcolor2" class="form-checkbox-success mb-2" checked>
              Success Checkbox
            </b-form-checkbox>
            <b-form-checkbox id="customCheckcolor3" class="form-checkbox-info mb-2" checked>
              Info Checkbox
            </b-form-checkbox>
            <b-form-checkbox id="customCheckcolor6" class="form-checkbox-secondary mb-2" checked>
              Secondary Checkbox
            </b-form-checkbox>
            <b-form-checkbox id="customCheckcolor4" class="form-checkbox-warning mb-2" checked>
              Warning Checkbox
            </b-form-checkbox>
            <b-form-checkbox id="customCheckcolor5" class="form-checkbox-danger mb-2" checked>
              Danger Checkbox
            </b-form-checkbox>
            <b-form-checkbox id="customCheckcolor7" class="form-checkbox-dark" checked>
              Dark Checkbox
            </b-form-checkbox>
          </div>
        </UIComponentCard>
        ...
        <UIComponentCard title="Disabled Radio" id="disabled-radio">
          <b-form-radio-group class="mt-3">
            <b-form-radio name="radio-disable" value="1" disabled
              >Check this custom checkbox</b-form-radio
            >
            <b-form-radio name="radio-disable" value="2" disabled
              >Check this custom checkbox</b-form-radio
            >
          </b-form-radio-group>
        </UIComponentCard>
        ...
        <UIComponentCard title="Switch" id="switch-basic">
          <b-form-group class="mt-3">
            ...
            <b-form-checkbox switch v-model="checked"
              >Checked switch checkbox input</b-form-checkbox
            >
            <b-form-checkbox switch disabled>Disabled switch checkbox input</b-form-checkbox>
            <b-form-checkbox switch v-model="checked" disabled
