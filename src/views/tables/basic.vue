      ...
      <b-col xl="9">
        <UIComponentCard id="basic" title="Basic Example">
          <b-table-simple responsive class="table-centered mb-0">
            <b-thead>
              <b-tr>
                <b-th v-for="(header, idx) in tableData.head" :key="idx" scope="col">{{
                  header
                }}</b-th>
              </b-tr>
            </b-thead>
                  ...
                  <div class="d-flex align-items-center gap-1">
                    ...
                    <div class="d-block">
                      <h5 class="mb-0 d-flex align-items-center gap-1">
                        Mary J. Germain<i class="bx bxs-badge-check text-success"></i>
                      </h5>
                    </div>
                  </div>
                </b-td>
                  ...
                  <b-table-simple class="mb-0">
                    ...
                    <b-tbody>
                      <b-tr>
                        ...
                        <b-td>
                          <b-badge :variant="null" class="bg-success-subtle text-success py-1 px-2"
                            >Verified</b-badge
                          >
                        </b-td>
                      </b-tr>
                      <b-tr>
                        ...
                        <b-td>
                          <b-badge :variant="null" class="bg-warning-subtle text-warning py-1 px-2"
                            >Pending</b-badge
                          >
                        </b-td>
                      </b-tr>
                      <b-tr>
                        ...
                        <b-td>
                          <b-badge :variant="null" class="bg-danger-subtle text-danger py-1 px-2"
                            >Rejected</b-badge
                          >
                        </b-td>
                      </b-tr>
