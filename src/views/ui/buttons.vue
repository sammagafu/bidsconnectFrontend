    ...
    <b-row>
      <b-col xl="9">
        ...
        <UIComponentCard title="Soft Rounded Buttons" id="soft-rounded">
          <div class="button-list mt-3">
            <b-button type="button" :variant="null" class="btn-soft-primary rounded-pill"
              >Primary</b-button
            >
            <b-button type="button" :variant="null" class="btn-soft-secondary rounded-pill"
              >Secondary</b-button
            >
            <b-button type="button" :variant="null" class="btn-soft-success rounded-pill"
              >Success</b-button
            >
            <b-button type="button" :variant="null" class="btn-soft-info rounded-pill"
              >Info</b-button
            >
            <b-button type="button" :variant="null" class="btn-soft-warning rounded-pill"
              >Warning</b-button
            >
          </div>
        </UIComponentCard>
