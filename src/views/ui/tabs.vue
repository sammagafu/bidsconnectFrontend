          ...
          <b-tabs content-class="text-muted" class="mt-3">
            ...
            <b-tab id="profile" active>
              ...
              <p class="mb-0">
                ...
                plu simplic e regulari quam ti del coalescent lingues. Li nov lingua franca va esser
        ...
        <UIComponentCard title="Tabs Vertical Left" id="toggle-between-modals">
          <b-row class="mt-3">
            <b-tabs
              ...
              nav-wrapper-class="col-sm-3 mb-2 mb-sm-0"
              pills
              vertical
              justified
            >
              ...
              <b-tab title="Profile" id="profile">
                <p class="mb-0">
                  ...
                  lingua franca va esser plu simplic e regulari quam li existent Europan lingues.
                </p>
              </b-tab>
        ...
        <UIComponentCard title="Tabs Vertical Right" id="varying-modal-content">
          <b-row class="mt-3">
            <b-tabs
              content-class="pt-0"
              nav-class="flex-column"
              nav-wrapper-class="col-sm-3 ms-2"
              pills
              vertical
              justified
              :end="true"
