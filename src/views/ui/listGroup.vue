        ...
        <UIComponentCard title="Checkboxes and radios" id="checkboxes-radios">
          <b-row class="mt-3">
            <b-col lg="6">
              <b-list-group>
                <b-list-group-item>
                  <b-form-checkbox class="me-1" id="checkbox-1" name="checkbox-1">
                    First checkbox</b-form-checkbox
                  >
                </b-list-group-item>
                <b-list-group-item>
                  <b-form-checkbox class="me-1" id="checkbox-2" name="checkbox-2">
                    Second checkbox</b-form-checkbox
                  >
                </b-list-group-item>
                <b-list-group-item>
                  <b-form-checkbox class="me-1" id="checkbox-3" name="checkbox-3">
                    Third checkbox</b-form-checkbox
                  >
                </b-list-group-item>
              </b-list-group>
            </b-col>
