      ...
      <b-col xl="9">
        ...
        >
          <b-row>
            <b-col md="6">
              <div
                class="toast fade show align-items-center mb-3"
                role="alert"
                aria-live="assertive"
                aria-atomic="true"
              >
            ...
            <b-col md="6">
              <div
                class="toast fade show align-items-center text-bg-primary mb-3"
                role="alert"
                aria-live="assertive"
                aria-atomic="true"
              >
          ...
          <b-row>
            <b-col md="6">
              <div
                class="toast fade show mb-3 mb-md-0"
                role="alert"
                aria-live="assertive"
                aria-atomic="true"
              >
            ...
            <b-col md="6">
              <div
                class="toast fade show text-bg-primary"
                role="alert"
                aria-live="assertive"
                aria-atomic="true"
              >
        ...
        <UIComponentCard title="Placement" id="placement">
          <div
            aria-live="polite"
            aria-atomic="true"
            class="bg-body-tertiary position-relative mt-3"
