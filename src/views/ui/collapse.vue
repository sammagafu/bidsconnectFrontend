      ...
      <b-col xl="9">
        ...
        <UIComponentCard title="Multiple Targets" id="multiple-targets">
          <div class="hstack gap-2 my-3">
            <b-button variant="primary" v-b-toggle.multiCollapseExample1
              >Toggle first element</b-button
            >
            <b-button variant="primary" v-b-toggle.multiCollapseExample2
              >Toggle second element</b-button
            >
            <b-button
              variant="primary"
              v-b-toggle="['multiCollapseExample1', 'multiCollapseExample2']"
            >
