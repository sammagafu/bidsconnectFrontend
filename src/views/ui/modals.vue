  ...
  <VerticalLayout>
    <b-row>
      <b-col xl="9">
        ...
        >
          <b-button variant="primary" @click="staticBackdropModal = !staticBackdropModal">
        ...
        >
          ...
          <b-button
            ...
            variant="primary"
            class="me-2"
            @click="scrollingLongModal = !scrollingLongModal"
          >
            Launch demo modal
          </b-button>

          <!-- Button trigger modal -->
          <b-button variant="primary" @click="scrollingLongModal1 = !scrollingLongModal1">
            Launch demo modal
          </b-button>
        </UIComponentCard>
        ...
        <UIComponentCard title="Modal Position" id="modal-position">
          <div class="d-flex flex-wrap gap-2 mt-3">
            <!-- Button trigger modal -->
            <b-button variant="primary" @click="verticalCenteredModal = !verticalCenteredModal">
            ...
            <b-button
              variant="primary"
              @click="verticalCenteredScrollableModal = !verticalCenteredScrollableModal"
            >
          ...
          <div class="d-flex flex-wrap gap-2 mt-3">
            ...
            <div class="hstack gap-2">
              ...
              <b-button variant="primary" @click="bottomModal = !bottomModal">
                Bottom Modal</b-button
              >
            </div>
          </div>
        </UIComponentCard>
        ...
        <UIComponentCard title="Optional Sizes" id="optional-sizes">
          <div class="hstack gap-2 mt-3">
            <!-- Button trigger modal -->
            <b-button variant="primary" @click="extraLargeModal = !extraLargeModal">
        ...
        <UIComponentCard title="Fullscreen Modal" id="fullscreen-modal">
          <div class="hstack flex-wrap gap-2 mt-3">
            ...
            <b-button variant="primary" @click="fsBSMModal = !fsBSMModal">
              Full screen below sm</b-button
            >
            <b-button variant="primary" @click="fsBMDModal = !fsBMDModal">
              Full screen below md</b-button
            >
            <b-button variant="primary" @click="fsBLGModal = !fsBLGModal">
              Full screen below lg</b-button
            >
            <b-button variant="primary" @click="fsBXLModal = !fsBXLModal">
              Full screen below xl</b-button
            >
            <b-button variant="primary" @click="fsBXXLModal = !fsBXXLModal">
        ...
        <UIComponentCard title="Modal Based Alerts" id="modal-alerts">
          <div class="hstack flex-wrap gap-2 mt-3">
            <b-button variant="primary" @click="primaryAlertModal = !primaryAlertModal">
              Primary Alert</b-button
            >
            <b-button variant="secondary" @click="secondaryAlertModal = !secondaryAlertModal">
              Secondary Alert</b-button
            >
    ...
    >
      <p>
        This is some placeholder content to show the scrolling behavior for modals. We use repeated
    ...
    <b-modal
      v-model="verticalCenteredScrollableModal"
      title="Modal title"
      ok-title="Save changes"
      cancel-title="Close"
      centered
    ...
    <!-- Second Modal -->
    <b-modal
      v-model="toggleModal2"
      title="Modal 2"
      ok-title="Back to first"
      cancel-title="Close"
      @ok="toggleModal"
      centered
    >
    ...
    <!-- Optional Sizes -->
    <b-modal v-model="extraLargeModal" title="Extra large modal" size="xl" hide-footer>
      ...</b-modal
    >
    ...
    >
      <div class="text-center">
        ...
        <b-button
          ...
          variant="light"
          class="mt-3"
          @click="primaryAlertModal = !primaryAlertModal"
        >
          Continue
        </b-button>
      </div>
    ...
    <b-modal
      v-model="secondaryAlertModal"
      hide-header
      hide-footer
      size="sm"
      content-class="modal-filled bg-secondary"
    >
      <div class="text-center">
        <i class="bx bx-check-double display-6 mt-0 text-white"></i>
        <h4 class="mt-3 text-white">Well Done!</h4>
        ...
        <b-button
          ...
          variant="light"
          class="mt-3"
          @click="secondaryAlertModal = !secondaryAlertModal"
        >
          Continue
        </b-button>
      </div>
    ...
    <b-modal
      v-model="successAlertModal"
      hide-header
      hide-footer
      size="sm"
      content-class="modal-filled bg-success"
    >
      <div class="text-center">
        <i class="bx bx-check-double display-6 mt-0 text-white"></i>
        <h4 class="mt-3 text-white">Well Done!</h4>
        ...
        <b-button
          ...
          variant="light"
          class="mt-3"
          @click="successAlertModal = !successAlertModal"
        >
          Continue
        </b-button>
      </div>
    ...
    <b-modal
      v-model="infoAlertModal"
      hide-header
      hide-footer
      size="sm"
      content-class="modal-filled bg-info"
    >
      <div class="text-center">
        <i class="bx bx-check-double display-6 mt-0 text-white"></i>
        <h4 class="mt-3 text-white">Well Done!</h4>
        ...
        <b-button
          ...
          variant="light"
          class="mt-3"
          @click="infoAlertModal = !infoAlertModal"
        >
          Continue
        </b-button>
      </div>
