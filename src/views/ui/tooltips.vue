      ...
      <b-col xl="9">
        ...
        >
          <div class="d-flex flex-wrap gap-2">
            <b-button variant="primary" v-b-tooltip.hover.top="'Tooltip on top'">
              Tooltip on top</b-button
            >
            <b-button variant="primary" v-b-tooltip.hover.right="'Tooltip on right'">
              Tooltip on right</b-button
            >
            <b-button variant="primary" v-b-tooltip.hover.bottom="'Tooltip on bottom'">
              Tooltip on bottom</b-button
            >
            <b-button variant="primary" v-b-tooltip.hover.left="'Tooltip on left'">
