      ...
      <div class="p-fluid">
        ...
        <div class="p-field">
          ...
          <Textarea
            ...
            v-model="newItem.recipient_address"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            ...
            v-model="newItem.company_description"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            id="attached_docs_list"
            v-model="newItem.attached_docs_list"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            id="compliance_certs"
            v-model="newItem.compliance_certs"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            id="agency_dealership"
            v-model="newItem.agency_dealership"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            id="lease_agreement"
            v-model="newItem.lease_agreement"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            id="litigation_decl"
            v-model="newItem.litigation_decl"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            id="similar_performance"
            v-model="newItem.similar_performance"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            id="financial_info"
            v-model="newItem.financial_info"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <Textarea
            id="physical_address"
            v-model="newItem.physical_address"
            rows="3"
            class="w-full"
            fluid
          />
        ...
        <div class="p-field">
          ...
          <InputText
            id="contact_position"
            v-model="newItem.contact_position"
            class="w-full"
            fluid
          />
        </div>
...
function generatePDF(item) {
  api
    .get(`automation/cover-letter/${item.id}/`, { responseType: 'blob' })
    .then((response) => {
